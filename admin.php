	...
	<body class="body">
		...
		<main class="admin-main-container">
			...
			<section class="admin-sec">
				<ul class="admin-list">
					<h6 class="item-header">Data Modification</h6>
					<li class="admin-item"><a href="backend/adminuses.php?run=editmovie">Edit Movie</a></li>
					<li class="admin-item"><a href="backend/adminuses.php?run=deletemovie">Delete Movie</a></li>
					<li class="admin-item"><a href="backend/adminuses.php?run=add">Add Movie</a></li>
					<li class="admin-item"><a href="backend/adminuses.php?run=delete">Delete User</a></li>
				</ul>
			</section>

			<section class="admin-sec">
				<ul class="admin-list">
					<h6 class="item-header">Reports</h6>
					<li class="admin-item"><a href="backend/adminuses.php?run=">Users</a></li>
					<li class="admin-item"><a href="backend/adminuses.php?run=">Movies</a></li>
					<li class="admin-item"><a href="backend/adminuses.php?run=">Sales</a></li>
				</ul>
			</section>
