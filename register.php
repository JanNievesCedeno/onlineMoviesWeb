...
<html>
	...
	<body class="register-body">
		...
		<main class="register-main-container">
				<form action="backend/registerdb.php" method="post" class="register-form">
					<div>
						<h2>Register, fill all the fields!</h2>
						<input class="register_i" type="text" name="first-name" placeholder="First Name(2 caracters min)" required>		
					</div>
					<div>
						<input class="register_i"type="text" name="last-name" placeholder="Last Name(2 caracters min)" required>	
					</div>
					<div>
						<input class="register_i"type="text" name="username" placeholder="Username(2 caracters min)" required>
					</div>
					<div>
						<input class="register_i"type="password" name="password" placeholder="Password(5 caracters min)" required>
					</div>
					<div class="cont_register">
						<input class="register_i"type="submit" name="register">
					</div>
				</form>  
